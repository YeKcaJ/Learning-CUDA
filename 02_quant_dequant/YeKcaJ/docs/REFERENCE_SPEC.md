...
Location after the structure refactor: `Core/reference/mxfp8/` and
`Core/reference/nvfp4/` (relative to the project root). Paths below are relative
to the corresponding reference directory. Source and frozen bytes are unchanged.
