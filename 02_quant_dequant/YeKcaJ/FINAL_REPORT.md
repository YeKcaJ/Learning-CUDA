...
[validation-20260909](records/validation-20260909/summary.json) 和 [SHA256.json](records/validation-20260909/SHA256.json)。
...
所有模式及三种输出的完整原始结果见 [144 组汇总](records/evaluation-warp-20260909/summary.json)。
...
硬件、编译器、CPU 信息和源码哈希见 [environment.json](records/performance-warp-20260909/environment.json)。
...
所有规模、输出 dtype、P95 和逻辑 GB/s 见 [完整性能表](records/performance-warp-20260909/RESULTS.md)。
...
结果见 [NVFP4 nsys](records/profiling-warp-20260909/nvfp4_stats.txt) 和
[MXFP8 nsys](records/profiling-warp-20260909/mxfp8_stats.txt)。
